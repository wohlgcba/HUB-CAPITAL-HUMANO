...
import { directoryStatus, metricsSummary } from "../../data/adminMetricsDemo";
...
export function DirectoryStatus() {
  const { percentage, complete, total } = metricsSummary.directoryCompletion;
